...
return [
    'shop' => [
        ...
        'checkout' => [
            ...
            'reward' => [
                'apply-success'   => 'تم تطبيق النقاط بنجاح.',
                'already-applied' => 'تحذير: تم تطبيق  النقاط بالفعل.',
                'invalid-code'    => 'تحذير: رمز الكوبون غير صالح.',
                'remove-success'  => 'تمت إزالة النقاط بنجاح.',
                'remove-failed'   => 'تحذير: لم يتم إزالة النقاط.',
            ],
